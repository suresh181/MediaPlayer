...
import com.my.mediaplayer.databinding.DetailsViewBinding
import com.my.mediaplayer.databinding.MoreFeatureBinding
import com.my.mediaplayer.databinding.MusicViewBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        if(!selectionActivity)
            holder.root.setOnLongClickListener {
                val customDialog = LayoutInflater.from(context).inflate(R.layout.more_feature, holder.root, false)
